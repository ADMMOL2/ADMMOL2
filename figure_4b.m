...
legend1 = legend('\lambda_{BH} given by eq(3.13)','\lambda given by eq(3.14), n=p','\lambda given by eq(3.14), n=2p');
set(legend1,'FontSize',18,'FontName','Times New Roman');
% Save the file as PNG
%print('E:\Deep Learning\Research\Paper Writting\graphs\lambda0055.png','-dpng','-r900');
%print('E:\Deep Learning\Research\Paper Writting\graphs\lambda0055.eps','-depsc2','-r900');
