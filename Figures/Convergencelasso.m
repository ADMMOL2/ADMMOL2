...
title('$||r^k||_2 \leq \epsilon^{pri}$','FontSize',18,'Interpreter','latex');
set(gca, 'FontSize', 18);
subplot(2,1,2);
...
title('$||s^k||_2 \leq \epsilon^{dual}$','FontSize',18,'Interpreter','latex');
set(gca, 'FontSize', 18);
print('E:\Deep Learning\Research\Paper Writting\graphs\Convergencelasso.eps','-depsc2','-r900');
print('E:\Deep Learning\Research\Paper Writting\graphs\Convergencelasso.png','-dpng','-r900');
